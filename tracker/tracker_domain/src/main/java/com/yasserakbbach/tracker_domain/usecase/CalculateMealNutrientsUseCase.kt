...
class CalculateMealNutrientsUseCase(
    ...
    private fun bmr(userInfo: UserInfo): Int =
        when(userInfo.gender) {
            is Gender.Male -> (66.47f + 13.75f * userInfo.weight + 5f * userInfo.height - 6.75f * userInfo.age).roundToInt()
            is Gender.Female ->  (665.09f + 9.56f * userInfo.weight + 1.84f * userInfo.height - 4.67 * userInfo.age).roundToInt()
        }
